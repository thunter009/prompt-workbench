...
export function PreviewSkeleton() {
  return (
    <div className="h-full flex flex-col bg-muted animate-pulse">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <div className="h-3 w-14 bg-accent rounded" />
        <div className="flex items-center gap-1">
          <div className="w-7 h-7 bg-accent rounded" />
          <div className="w-7 h-7 bg-accent rounded" />
        </div>
      </div>
      {/* Content area */}
      <div className="flex-1 p-4 space-y-3">
        {/* Heading */}
        <div className="h-7 bg-accent rounded w-2/3" style={{ opacity: 0.5 }} />
        {/* Paragraphs */}
        ...
        {/* Code block */}
        <div className="h-20 bg-background rounded mt-4" style={{ opacity: 0.5 }} />
        {/* More paragraphs */}
